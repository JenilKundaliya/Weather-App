...
const WeatherApp = () => {
  ...
  return (
    <div className="px-4 py-2 weather-app-main col-12 d-flex flex-column align-items-center">
      <div className="city-search d-flex flex-column my-4 col-8">
        ...
        <div className="col-6 d-flex flex-row">
          ...
          <button
            className="btn btn-outline-success rounded-0 ms-2 px-2 text-nowrap bg-light text-dark border-light"
            onClick={() => {
              fetchWeatherData();
            }}
          >
      ...
      {weatherData && Object.keys(weatherData)?.length > 0 ? (
        <div className="col-12 d-flex flex-column align-items-center mt-4">
          <div className="col-8 d-flex flex-row justify-content-center align-items-center p-2 border border-light shadow py-4">
          ...
          <div className="col-8 d-flex mt-4 text-start">
            <p
          ...
          <div className="col-8 row border border-light shadow-lg p-2">
            {weatherParameters?.map((val, idx) => {
              return (
                <div className="weather-parameter col-4 p-2" key={idx}>
        ...
        <div className="col-12 d-flex flex-column no-weather-data justify-content-center align-items-center mt-4">
          <div className="col-8 d-flex flex-column justify-content-center align-items-center border border-light py-4">
            <img
